  ...
  <div class="flex items-center space-x-10">
    ...
    <nav>
      <ul class="flex space-x-8 text-white font-medium">
        ...
        <li><a href="<?= $base_url ?>controllers/trackOrderController.php">Track Order</a></li>
        <li><a href="<?= $base_url ?>views/logout.php" id="logoutLink">Logout</a></li>
      </ul>
    </nav>
  </div>
  <div class="flex items-center space-x-4">
            <a href="<?= $base_url?>controllers/checkoutController.php"><i class="fa-solid fa-cart-plus text-white text-3xl"  ></i></a>
            <a href="<?= $base_url?>controllers/manageCustomerController.php"><i class="fa-solid fa-user text-white text-3xl"></i></a>
        </div>
    </header>
